 ...
 * $Revision: 1$
 * $Date: 15/09/24 2:35p $
 * @brief    N575 series CLK driver header file
 *
 * @note
...
/** @addtogroup N575_CLK_Driver CLK Driver
  @{
*/

/** @addtogroup N575_CLK_EXPORTED_CONSTANTS CLK Exported Constants
  @{
*/
...
/*@}*/ /* end of group N575_CLK_EXPORTED_CONSTANTS */


/** @addtogroup N575_CLK_EXPORTED_FUNCTIONS CLK Exported Functions
  @{
*/
...
/*@}*/ /* end of group N575_CLK_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group N575_CLK_Driver */
