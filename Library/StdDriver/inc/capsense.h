 ...
 * @version  V1.00
 * $Revision: 2 $
 * $Date: 15/09/24 11:00a $
 * @brief    N575 Series Capture Sense Header File
 *
 * @note
...
/** @addtogroup N575_CAPSENSE_Driver CapSense Driver
  @{
*/

/** @addtogroup N575_CAPSENSE_EXPORTED_CONSTANTS CapSense Exported Constants
  @{
*/
...
/*@}*/ /* end of group N575_CAPSENSE_EXPORTED_CONSTANTS */

/** @addtogroup N575_CAPSENSE_EXPORTED_FUNCTIONS CapSense Exported Functions
  @{
*/
...
/*@}*/ /* end of group N575_CAPSENSE_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group N575_CAPSENSE_Driver */
