 ...
 * $Revision: 2 $
 * $Date: 15/09/24 7:06p $
 * @brief    N575 BOD driver header file
 *
 * @note
...
/** @addtogroup N575_BOD_Driver BOD Driver
  @{
*/


/** @addtogroup N575_BOD_EXPORTED_CONSTANTS BOD Exported Constants
  @{
*/
...
/*@}*/ /* end of group N575_BOD_EXPORTED_CONSTANTS */


/** @addtogroup N575_BOD_EXPORTED_FUNCTIONS BOD Exported Functions
  @{
*/
...
/*@}*/ /* end of group N575_BOD_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group N575_BOD_Driver */
