 ...
 * @version  V1.00
 * $Revision: 1 $
 * $Date: 15/09/24 15:06p $
 * @brief    N575 TALARM driver header file
 *
 * @note
...
/** @addtogroup N575_TALARM_Driver TALARM Driver
  @{
*/


/** @addtogroup N575_TALARM_EXPORTED_CONSTANTS TALARM Exported Constants
  @{
*/
...
/*@}*/ /* end of group N575_TALARM_EXPORTED_CONSTANTS */

/** @addtogroup N575_TALARM_EXPORTED_FUNCTIONS TALARM Exported Functions
  @{
*/
...
/*@}*/ /* end of group N575_TALARM_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group N575_TALARM_Driver */
