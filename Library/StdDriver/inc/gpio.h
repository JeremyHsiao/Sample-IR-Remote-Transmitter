 ...
 * $Revision: 1 $
 * $Date: 15/09/24 2:52p $
 * @brief    N575 GPIO driver header file
 *
 * @note
...
/** @addtogroup N575_GPIO_Driver GPIO Driver
  @{
*/

/** @addtogroup N575_GPIO_EXPORTED_CONSTANTS GPIO Exported Constants
  @{
*/
...
/*@}*/ /* end of group N575_GPIO_EXPORTED_CONSTANTS */

/** @addtogroup N575_GPIO_EXPORTED_FUNCTIONS GPIO Exported Functions
  @{
*/
...
/*@}*/ /* end of group N575_GPIO_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group N575_GPIO_Driver */
