 ...
 * @version  V1.00
 * $Revision: 1 $
 * $Date: 15/09/24 07:27p $
 * @brief    N575 Series DPWM Driver Header File
 *
 * @note
...
/** @addtogroup N575_DPWM_Driver DPWM Driver
  @{
*/

/** @addtogroup N575_DPWM_EXPORTED_CONSTANTS DPWM Exported Constants
  @{
*/ 
...
/*@}*/ /* end of group N575_DPWM_EXPORTED_CONSTANTS */

/** @addtogroup N575_DPWM_EXPORTED_FUNCTIONS DPWM Exported Functions
  @{
*/
...
/*@}*/ /* end of group N575_DPWM_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group N575_DPWM_Driver */
