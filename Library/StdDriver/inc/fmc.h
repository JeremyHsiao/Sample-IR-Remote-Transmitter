 ...
 * $Revision: 1 $
 * $Date: 15/09/24 2:52p $
 * @brief    N575 Flash Memory Controller Driver Header File
 *
 * @note
...
/** @addtogroup N575_FMC_Driver FMC Driver
  @{
*/

/** @addtogroup N575_FMC_EXPORTED_CONSTANTS FMC Exported Constants
  @{
*/
...
#define FMC_APROM_END           0x00023400UL    /*!< APROM End Address            \hideinitializer */
...
#define FMC_FLASH_PAGE_SIZE     0x400           /*!< Flash Page Size (1 Kbytes)   \hideinitializer */
...
/*@}*/ /* end of group N575_FMC_EXPORTED_CONSTANTS */


/** @addtogroup N575_FMC_EXPORTED_FUNCTIONS FMC Exported Functions
  @{
*/
...
/*@}*/ /* end of group N575_FMC_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group N575_FMC_Driver */
