 ...
 * $Revision: 1 $
 * $Date: 15/09/24 2:52p $
 * @brief    N575 I2S driver header file
 *
 * @note
...
/** @addtogroup N575_I2S_Driver I2S Driver
  @{
*/

/** @addtogroup N575_I2S_EXPORTED_CONSTANTS I2S Exported Constants
  @{
*/
...
/*@}*/ /* end of group N575_I2S_EXPORTED_CONSTANTS */

/** @addtogroup N575_I2S_EXPORTED_FUNCTIONS I2S Exported Functions
  @{
*/
/*---------------------------------------------------------------------------------------------------------*/
/* inline functions                                                                                        */
...
/*@}*/ /* end of group N575_I2S_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group N575_I2S_Driver */
