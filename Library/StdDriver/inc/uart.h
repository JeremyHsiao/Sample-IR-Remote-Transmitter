 ...
 * $Revision: 2 $
 * $Date: 15/09/24 2:50p $
 * @brief    N575 Series UART driver header file
 *
 * @note
...
/** @addtogroup N575_UART_Driver UART Driver
  @{
*/

/** @addtogroup N575_UART_EXPORTED_CONSTANTS UART Exported Constants
  @{
*/
...
/*@}*/ /* end of group N575_UART_EXPORTED_CONSTANTS */


/** @addtogroup N575_UART_EXPORTED_FUNCTIONS UART Exported Functions
  @{
*/
 ...
 *                               - UART_INTSTS_RDAIF_Msk     : Receive Data Available Interrupt Flag (Read Only)
 *                               - UART_INTSTS_THREIF_Msk    : Transmit Holding Register Empty Interrupt Flag (Read Only)
 *                               - UART_INTSTS_RLSIF_Msk     : Receive Line Status Interrupt Flag (Read Only)
 *                               - UART_INTSTS_MODENIF_Msk   : MODEM Interrupt Flag (Read Only)
 *                               - UART_INTSTS_RXTOIF_Msk    : Time Out Interrupt Flag (Read Only)
 *                               - UART_INTSTS_BUFERRIF_Msk  : Buffer Error Interrupt Flag (Read Only)
 *                               - UART_INTSTS_LINIF_Msk     : LIN Bus Rx Break Field Detected Flag
 *
 *    @return
...
/*@}*/ /* end of group N575_UART_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group N575_UART_Driver */
