 ...
 * $Revision: 2 $
 * $Date: 14/07/17 2:50p $
 * @brief    ISD9100 Series UART driver header file
 *
 * @note
...
/** @addtogroup ISD9100_UART_Driver UART Driver
  @{
*/

/** @addtogroup ISD9100_UART_EXPORTED_CONSTANTS UART Exported Constants
  @{
*/
...
/*@}*/ /* end of group ISD9100_UART_EXPORTED_CONSTANTS */


/** @addtogroup ISD9100_UART_EXPORTED_FUNCTIONS UART Exported Functions
  @{
*/
...
/*@}*/ /* end of group ISD9100_UART_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group ISD9100_UART_Driver */
