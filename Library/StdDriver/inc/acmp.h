 ...
 * @version  V1.00
 * $Revision: 1 $
 * $Date: 15/09/24 16:25p $
 * @brief    N575 Series ACMP Driver Header File
 *
 * @note
...
/** @addtogroup N575_ACMP_Driver ACMP Driver
  @{
*/

/** @addtogroup N575_ACMP_EXPORTED_CONSTANTS ACMP Exported Constants
  @{
*/  
...
/*@}*/ /* end of group N575_ACMP_EXPORTED_CONSTANTS */

/** @addtogroup N575_ACMP_EXPORTED_FUNCTIONS ACMP Exported Functions
  @{
*/
...
/*@}*/ /* end of group N575_ACMP_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group N575_ACMP_Driver */
