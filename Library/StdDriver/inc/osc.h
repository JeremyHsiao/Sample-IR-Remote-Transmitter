 ...
 * @version  V1.00
 * $Revision: 2 $
 * $Date: 15/09/24 10:00a $
 * @brief    N575 Series OSC Header File
 *
 * @note
...
/** @addtogroup N575_OSC_Driver OSC Driver
  @{
*/

/** @addtogroup N575_OSC_EXPORTED_CONSTANTS OSC Exported Constants
  @{
*/
...
/*@}*/ /* end of group N575_OSC_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group N575_OSC_Driver */
