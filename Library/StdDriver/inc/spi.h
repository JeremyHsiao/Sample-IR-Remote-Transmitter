 ...
 * @version  V1.00
 * $Revision: 1 $
 * $Date: 15/09/24 10:10a $
 * @brief    N575 SPI driver header file
 *
 * @note
...
/** @addtogroup N575_SPI_Driver SPI Driver
  @{
*/

/** @addtogroup N575_SPI_EXPORTED_CONSTANTS SPI Exported Constants
  @{
*/
...
/*@}*/ /* end of group N575_SPI_EXPORTED_CONSTANTS */

/** @addtogroup N575_SPI_EXPORTED_FUNCTIONS SPI Exported Functions
  @{
*/
...
/*@}*/ /* end of group N575_SPI_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group N575_SPI_Driver */
