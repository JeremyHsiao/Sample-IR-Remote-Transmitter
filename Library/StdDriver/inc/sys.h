 ...
 * @version  V1.00
 * $Revision: 1 $
 * $Date: 15/09/24 11:40a $
 * @brief    N575 Series SYS Header File
 *
 * @note
...
/** @addtogroup N575_SYS_Driver SYS Driver
  @{
*/

/** @addtogroup N575_SYS_EXPORTED_CONSTANTS SYS Exported Constants
  @{
*/
...
/*@}*/ /* end of group N575_SYS_EXPORTED_CONSTANTS */

/** @addtogroup N575_SYS_EXPORTED_FUNCTIONS SYS Exported Functions
  @{
*/
...
/*@}*/ /* end of group N575_SYS_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group N575_SYS_Driver */
