 ...
 * @version  V1.00
 * $Revision: 2 $
 * $Date: 15/09/24 11:27a $
 * @brief    N575 Series BIQ Driver Header File
 *
 * @note
...
/** @addtogroup N575_BIQ_Driver BIQ Driver
  @{
*/

/** @addtogroup N575_BIQ_EXPORTED_CONSTANTS BIQ Exported Constants
  @{
*/  
...
/*@}*/ /* end of group N575_BIQ_EXPORTED_CONSTANTS */

/** @addtogroup N575_BIQ_EXPORTED_FUNCTIONS BIQ Exported Functions
  @{
*/
...
/*@}*/ /* end of group N575_BIQ_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group N575_BIQ_Driver */
