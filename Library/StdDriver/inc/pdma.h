 ...
 * $Revision: 1 $
 * $Date: 15/09/24 2:52p $
 * @brief    N575 Series PDMA Controller Driver Header File
 *
 * @note
...
/** @addtogroup N575_PDMA_Driver PDMA Driver
  * @{
  */

/** @addtogroup N575_PDMA_EXPORTED_CONSTANTS PDMA Exported Constants
  @{
*/
...
/*@}*/ /* end of group N575_PDMA_EXPORTED_CONSTANTS */

/** @addtogroup N575_PDMA_EXPORTED_FUNCTIONS PDMA Exported Functions
  @{
*/
...
/*@}*/ /* end of group N575_PDMA_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group N575_PDMA_Driver */
