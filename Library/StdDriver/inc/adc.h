 ...
 * @version  V1.00
 * $Revision: 5 $
 * $Date: 15/09/24 13:27p $
 * @brief    N575 Series ADC Driver Header File
 *
 * @note
...
/** @addtogroup N575_ADC_Driver ADC Driver
  @{
*/

/** @addtogroup N575_ADC_EXPORTED_CONSTANTS ADC Exported Constants
  @{
*/  
...
/*@}*/ /* end of group N575_ADC_EXPORTED_CONSTANTS */


/** @addtogroup N575_ADC_EXPORTED_FUNCTIONS ADC Exported Functions
  @{
*/
...
/**
  ...
  * @return     None
  * @details    N575 provides a Programmable Gain Amplifier (PGA) as the front-end
...
/*@}*/ /* end of group N575_ADC_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group N575_ADC_Driver */
