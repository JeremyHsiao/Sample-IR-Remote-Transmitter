 ...
 * @version  V3.0
 * $Revision: 1 $
 * $Date: 15/09/24 11:06a $
 * @brief    N575 Series Peripheral Access Layer Header File
 *
 * @note
...
/**
  ...
  *
  *
  * This user manual describes the usage of N575 Series MCU device driver
  *
  * <b>Disclaimer</b>
  *
...
/** @addtogroup N575_CMSIS Device Definitions for CMSIS
  N575 Interrupt Number Definition and Configurations for CMSIS
  @{
*/
...
/*@}*/ /* end of group N575_CMSIS */

#include "core_cm0.h"                   /* Cortex-M0 processor and core peripherals               */
#include "system_N575.h"              /* ISD9xx System include file                             */
...
typedef struct
{
     ...
     * |        |          |For master mode, I2S_BCLK and I2S_FS pins are outputs and send bit clock and frame sync from N575.
     ...
     * |        |          |The N575 can generate a master clock signal to an external audio CODEC to synchronize the audio devices.
 ...
 */
     ...
     * |        |          |N575 can generate a master clock to synchronously drive an external audio device.
     ...
     * |        |          |If I2S operates in master mode, bit clock is provided by N575.
...
/******************************************************************************/
/** @addtogroup N575_PERIPHERAL_MEM_MAP N575 Peripheral Memory Map
  Memory Mapped Structure for N575 Series Peripheral
  @{
 */
...
/*@}*/ /* end of group N575_PERIPHERAL_MEM_MAP */
/******************************************************************************/
/*                         Peripheral declaration                             */
/******************************************************************************/
/** @addtogroup N575_PeripheralDecl N575 Peripheral Declaration
    @{
*/
...
/*@}*/ /* end of group N575_PeripheralDecl */
...
//=============================================================================
/** @addtogroup N575_IO_ROUTINE N575 I/O routines
  The Declaration of N575 I/O routines
  @{
 */
...
/*@}*/ /* end of group N575_IO_ROUTINE */




/** @addtogroup N575_legacy_Constants N575 Legacy Constants
  N575 Legacy Constants
  @{
*/
...
/*@}*/ /* end of group N575_legacy_Constants */

/*@}*/ /* end of group N575_Definitions */

#define __N575_SERIES__  (0x05750145)
#define __CHIP_SERIES__  __N575_SERIES__
